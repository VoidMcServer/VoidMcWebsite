const translations = {
  en: {
    ...
    server_info: "1 Rule Anarchy Server with Java & Bedrock Crossplay • 99% uptime",
    ...
    license_desc: "All in-game assets are subject to Mojang Studios' Minecraft EULA. Server-specific scripts and models belong to xyverse.",
    ...
    faq1_answer: "Server runs on 1.21.8. And supports Java & Bedrock.",
    ...
    faq4_question: "How Can I Learn Duping",
